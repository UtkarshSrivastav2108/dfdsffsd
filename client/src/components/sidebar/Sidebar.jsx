    ...
    <div className="sidebar">
      ...
      <div className="sidebarItem">
        ...
        <div className="sidebarSocial">
          <a href=""><i className="sidebarIcon fab fa-facebook-square"></i></a>
          <a href=""><i className="sidebarIcon fab fa-twitter-square"></i></a>
          <a href=""><i className="sidebarIcon fab fa-pinterest-square"></i></a>
